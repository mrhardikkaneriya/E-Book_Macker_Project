<?php
session_start();
if(isset($_SESSION['ad_id']) || isset($_SESSION['au_id'])){
	...
	$html = "Book Title : <br>".$res1['book_title']."<br><br>Book Description : <br>".$res1['book_description'];
	...
	$html = "<center><h1>Thanks..!</h1></center>";
